...
cout << "PI : " << sizeof(CirPiGate) << endl;
cout << "PO : " << sizeof(CirPoGate) << endl;
cout << "AIG: " << sizeof(CirAigGate) << endl;
cout << "CONST: " << sizeof(CirConstGate) << endl;
cout << "UNDEF: " << sizeof(CirUndefGate) << endl;
*/
...
{
   cout << setw(15) << left << "CIRRAR: "
        << "conduct SAT-controlled redundancy adition and removal\n";
}